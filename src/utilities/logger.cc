                ...
                if (color_) {
                    ...
                    switch (lv) {
                        ...
                        case Level::Debug:
                            ...
                            break;
                        case Level::Info:
                            level_fg = "\033[38;2;30;190;150m";   // cyan
                            icon     = "*";
                            break;
                        case Level::Warn:
                            level_fg = "\033[38;2;240;96;160m";   // pink
                            icon     = "!";
                            break;
                        case Level::Error:
                            level_fg = "\033[38;2;230;64;96m";    // cherry
                            icon     = "X";
                            break;
                        case Level::Critical:
